                        ...
                        <form onSubmit={(e) => { e.preventDefault() }}>
                            <div className={styleSignUpRide.flexInput + ' ' + styleSignUpRide.marginBot}>
                                <div className={styleSignUpRide.width50}>
                                    ...
                                    <input className={styleSignInRide.signInInput}
                            ...
                            <div className={styleSignUpRide.marginBot}>
                                ...
                                <input
                                    className={`${styleSignInRide.signInInput} ${(this.state.errors.city) ? styleSignInRide.inputalert : ''}`}
                                    type="text" placeholder="City"
                                    onChange={(e) => { this.setState({ city: e.target.value }) }} />
                                <span className={`${styleSignInRide.inputSpan} ${styleSignInRide.alertspan}`}>{this.state.errors.city}</span>
                            </div>
                            <div className={styleSignUpRide.marginBot}>
                                ...
                                <input
                                    ...
                                    type="text" placeholder="Privat key"
