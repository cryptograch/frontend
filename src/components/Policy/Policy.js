            ...
            <div className={styleSignInRider.signInBackground}>
                ...
                <div className={style.inner}>
                    ...
                    <p className={style.policy__p}>
                        Cryptograch ("us", "we", or "our") operates the website and the Cryptograch mobile application (the "Service").
                    </p>
                    <p className={style.policy__p}>
                    ...
                    <h3 className={style.title__h2}>
                        Types of Data Collected
                    </h3>
                    <h4 className={style.title__h2}>
                        Personal Data
                    </h4>
                    <p className={style.policy__p}>
                    ...
                    <p className={style.policy__p}>
                        This Usage Data may include information such as your computer's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that you visit,
                        the time and date of your visit, the time spent on those pages, unique device identifiers and other diagnostic data.
                    </p>
                    <p className={style.policy__p}>
                        When you access the Service by or through a mobile device, this Usage Data may include information such as the type of mobile device you use, your mobile device unique ID, the IP
                        address of your mobile device, your mobile operating system, the type of mobile Internet browser you use, unique device identifiers and other diagnostic data.
                    </p>
                    <h4 className={style.title__h2}>
                        Location
                    </h4>
                    <p className={style.policy__p}>
                        Depending on the our services that you use, and your app settings or device permissions,
                        we may collect your precise or approximate location information as determined through data such as GPS, IP address and WiFi.
                    </p>
                    <h4 className={style.title__h2}>
                        Camera
                    </h4>
                    <p className={style.policy__p}>
                        We way use camera by users permission for uploading photo on profile.
                    </p>
                    <h4 className={style.title__h2}>
                    ...
                    <p className={style.policy__p}>
                        ...
                        device. Tracking technologies also used are beacons, tags, and scripts to collect and track information and to improve and analyze our Service.
                    </p>
                    <p className={style.policy__p}>
                    ...
                    <p className={style.policy__p}>
                        Cryptograch uses the collected data for various purposes:
                    </p>
                    <ul>
                    ...
                    <p className={style.policy__p}>
                        Cryptograch will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take
                    ...
                    <p className={style.policy__p}>
                        Cryptograch may disclose your Personal Data in the good faith belief that such action is necessary to:
                    </p>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of Cryptograch</li>
                    ...
                    <p className={style.policy__p}>
                        We do not knowingly collect personally identifiable information from anyone under the age of 18. If you are a parent or guardian and you are aware that your Children has provided us
                        with Personal Data,
                    ...
                    <ul>
                        <li>By email: 1bs15b.pavlivskiy@gmail.com</li>
                    </ul>
                </div>
            </div>
